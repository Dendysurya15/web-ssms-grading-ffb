...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xl-4 d-flex justify-content-end" style="padding-right: 100px;">
                <form class="" action="{{ route('grafik') }}" method="get"> <!-- Moved the form here -->
                    <div class="row">
                        <div class="col-md-6">
                            <p class="ml-auto">Pilih Mill</p>
                        </div>
                        <div class="col-md-6">
                            <select name="getmillid" id="getmillid" onchange="this.form.submit()">
                    ...
                    <div class="card card-red">
                        <div class="card-header" style="background-color: #02A452;color:white">
                            <div class=" card-title">
                                <i class="fas fa-water pr-2"></i>Grading realtime jumlah janjang masuk <span id="pks1"></span>
                                hari
                                {{$dateToday}}
                            </div>
...
<script type="text/javascript">
    ...
    var getmillid = <?php echo  $getmillid ?>;

    // console.log(getmillid);
    ...
    $(document).ready(function() {
        ...
        var selectElement = document.getElementById('getmillid');
        var desiredId = getmillid

        $(selectElement).val(desiredId); // Set the value of the select element

        var millText = $("#getmillid option:selected").text(); // Get the selected text
        // console.log(millText);

        var namaMill = document.getElementById('pks1');
